...
export function parseTypeExpr(source, file) {
    const tokens = tokenize(source, file);
    // Remove EOF token for cleaner parsing
    const state = { tokens: tokens.slice(0, -1), pos: 0 };
