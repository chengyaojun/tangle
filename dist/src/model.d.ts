...
export type HeadingRole = "program" | "section" | "type" | "callable" | "semantic-section" | "semantic-atom";
export type DirectiveKind = "export" | "entry" | "deprecated" | "test" | "hideCode" | "error" | "rule.table" | "rule.tree" | "rule.toggle" | "rule.flow";
...
export type SymbolKind = "entry" | "type" | "callable" | "semantic-internal";
